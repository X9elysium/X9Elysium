# Chanakya-Musk Engine

Personal strategy folder. Foundation is the CliftonStrengths-derived blueprint mapping your five signature themes (Positivity, Analytical, Responsibility, Includer, Activator) onto Chanakya Neeti's strategic principles. Deep research stress-tests that foundation through the Naval Ravikant and Peter Thiel lenses — leverage, specific knowledge, monopoly, secrets, distribution, and durability.

This folder is private. It is not linked from any site navigation, sitemap, or content surface, and it sits outside `app/`/`pages/` so it is never exported.
