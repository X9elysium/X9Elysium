...
import { fadeUp, sectionTransition, smoothEase, staggerContainer } from "../lib/animations";
    ...
    <section className="section-warm overflow-hidden" ref={ref}>
      ...
      <div className="section-container">
        <motion.div
          ...
          className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 items-center justify-items-center gap-x-8 gap-y-10 sm:gap-x-12 sm:gap-y-12"
        >
          {techPartners.map((partner) => (
            <motion.div
              ...
              className="text-neutral-900/35 dark:text-white/35 hover:text-neutral-900/70 dark:hover:text-white/80 transition-colors duration-500"
            >
              {partner.logo}
            </motion.div>
          ))}
